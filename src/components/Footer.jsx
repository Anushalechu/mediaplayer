...
function Footer() {
  return (
    ...
    <div className='d-flex justify-content-center align-item-center mt-5'>
      <div className='footer d-flex align-item-center justify-content-evenly'>
        <div className='website' style={{ width: "400px" }}>
          ...
          <p style={{textAlign:"justify"}}>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Excepturi mollitia sequi, nulla laborum eaque nesciunt praesentium sint ducimus quaerat? Mollitia debitis amet asperiores, illum dolore beatae tenetur! Ipsum, hic commodi?</p>
        </div>
    ...
    <p className='ms-5 text-center'>copyright &copy; 2023 media player. Built with react</p>
    </>
